...
namespace TransportathonApp.Persistence.Migrations
{
    ...
    [Migration("20230912200433_Initialize")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TransportathonApp.Domain.Entities.TransportationRequestOffers", b =>
                {
                    b.Property<int>("TransportationOfferId")
                        .HasColumnType("int");
                    ...
                    b.HasKey("TransportationOfferId", "TransportationRequestId");

                    b.HasIndex("TransportationRequestId");

                    b.ToTable("TransportationRequestOffers");
                });
            ...
            modelBuilder.Entity("TransportathonApp.Domain.Entities.TransportationRequestOffers", b =>
                {
                    ...
                    b.HasOne("TransportathonApp.Domain.Entities.TransportationRequest", "Request")
                        .WithMany()
                        .HasForeignKey("TransportationRequestId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
