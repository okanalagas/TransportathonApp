        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_CompanyExecutives_AspNetUsers_Id",
                        column: x => x.Id,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CompanyExecutiveId = table.Column<int>(type: "int", nullable: false),
                    CreatedDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedDate = table.Column<DateTime>(type: "datetime2", nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Companies_CompanyExecutives_Id",
                        column: x => x.Id,
                        principalTable: "CompanyExecutives",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_TransportationRequests_Customers_CustomerId",
                        column: x => x.CustomerId,
                        principalTable: "Customers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TransportationTeams", x => x.Id);
                    table.ForeignKey(
                        name: "FK_TransportationTeams_Companies_CompanyId",
                        column: x => x.CompanyId,
                        principalTable: "Companies",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TransportationTeamId = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TransportationOffers", x => x.Id);
                    table.ForeignKey(
                        name: "FK_TransportationOffers_Companies_CompanyId",
                        column: x => x.CompanyId,
                        principalTable: "Companies",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_TransportationOffers_CompanyExecutives_CompanyExecutiveId",
                        column: x => x.CompanyExecutiveId,
                        principalTable: "CompanyExecutives",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_TransportationOffers_Drivers_DriverId",
                        column: x => x.DriverId,
                        principalTable: "Drivers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_TransportationOffers_TransportationTeams_TransportationTeamId",
                        column: x => x.TransportationTeamId,
                        principalTable: "TransportationTeams",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_TransportationOffers_Vehicles_VehicleId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Reservations_Reviews_Id",
                        column: x => x.Id,
                        principalTable: "Reviews",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Reservations_TransportationOffers_TransportationOfferId",
                        column: x => x.TransportationOfferId,
                        principalTable: "TransportationOffers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Reservations_TransportationRequests_TransportationRequestId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Reservations_TransportationOfferId",
                table: "Reservations",
                column: "TransportationOfferId");

            migrationBuilder.CreateIndex(
                name: "IX_Reservations_TransportationRequestId",
                table: "Reservations",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TransportationOffers_CompanyExecutiveId",
                table: "TransportationOffers",
                column: "CompanyExecutiveId");

            migrationBuilder.CreateIndex(
                name: "IX_TransportationOffers_CompanyId",
                table: "TransportationOffers",
                column: "CompanyId");

            migrationBuilder.CreateIndex(
                name: "IX_TransportationOffers_DriverId",
                table: "TransportationOffers",
                column: "DriverId");

            migrationBuilder.CreateIndex(
                name: "IX_TransportationOffers_TransportationTeamId",
                table: "TransportationOffers",
                column: "TransportationTeamId");

            migrationBuilder.CreateIndex(
                name: "IX_TransportationOffers_VehicleId",
                table: "TransportationOffers",
                column: "VehicleId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TransportationRequests_CustomerId",
                table: "TransportationRequests",
                column: "CustomerId");

            migrationBuilder.CreateIndex(
                name: "IX_TransportationTeams_CompanyId",
                table: "TransportationTeams",
                column: "CompanyId");
